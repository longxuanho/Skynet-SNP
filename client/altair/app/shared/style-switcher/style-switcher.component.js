angular.module('angular-skynet').directive('styleSwitcher', function($rootScope,$document,$state,$timeout) {
    return {
        restrict: 'E',
        templateUrl: 'client/altair/app/shared/style-switcher/style-switcher.html',
        controllerAs: 'StyleSwitcher',
