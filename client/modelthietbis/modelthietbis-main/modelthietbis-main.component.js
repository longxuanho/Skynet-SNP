angular.module('angular-skynet').directive('modelthietbisMain', function() {
    return {
        restrict: 'E',
        templateUrl: 'client/modelthietbis/modelthietbis-main/modelthietbis-main.html',
        controllerAs: 'ModelThietBisMain',
        controller: function($scope, skynetHelpers, $rootScope, $state, $stateParams, iNotifier) {
            ...
            $scope.helpers({
                ...
                isCanBeRemoved: () => {
                    let err = $scope._helpers.validateUser('can_delete_model_thiet_bi');
                    if (_.isEmpty(err))
                        return true;
                    return false;
                }
            ...
            $scope.removeChungLoai = (modelthietbi) => {
                let err = $scope._helpers.validateUser('can_delete_model_thiet_bi');
                if (_.isEmpty(err)) {
